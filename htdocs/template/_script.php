...
<!-- .. -->
<!-- masonry with imageUploaded library -->
<script src="https://unpkg.com/imagesloaded@5/imagesloaded.pkgd.min.js"></script>
<!-- .. -->
<!-- Dialog Core UI -->
<!-- 
    core UI is good if any problem in future then change the framework, to use this change this.options = {
      framework: "bootstrap",
      clone_id: "dummy-dialog-modal",
    };
    framework: "bootstrap" to framework: "coreui" in dialog.js file 
-->
